...
static struct exfat_repair_problem problems[] = {
	...
	{ER_FILE_INVALID_CLUS, 0, ERP_TRUNCATE},
	{ER_FILE_FIRST_CLUS, 0, ERP_TRUNCATE},
	{ER_FILE_SMALLER_SIZE, 0, ERP_TRUNCATE},
	{ER_FILE_LARGER_SIZE, 0, ERP_TRUNCATE},
	{ER_FILE_DUPLICATED_CLUS, 0, ERP_TRUNCATE},
	{ER_FILE_ZERO_NOFAT, 0, ERP_FIX},
	{ER_BITMAP_MISMATCH, 0, ERP_TRUNCATE},
};
